...
export default {
    ...
    template: `
        ...
        <main v-else class="page-roulette">
            <div class="sidebar">
                <p class="type-label-md" style="color: var(--color-on-background); opacity: 0.7;">
                    ...
                    <template v-if="levels.length > 0">
                        ...
                        <div class="level" v-for="(level, i) in levels.slice(0, progression.length)">
                            ...
                            <div class="meta">
                                <p>#{{ level.rank }}</p>
                                <h2>{{ level.name }}</h2>
                                <p style="color: var(--color-success); font-weight: 700">{{ progression[i] }}%</p>
                            </div>
                        </div>
                        <!-- Current Level -->
                        <div class="level" v-if="!hasCompleted">
                            ...
                            <form class="actions" v-if="!givenUp">
                                ...
                                <Btn @click.native.prevent="onGiveUp" style="background-color: var(--color-error);">Give Up</Btn>
                            </form>
                        </div>
                        <!-- Results -->
                        ...
                        <template v-if="givenUp && showRemaining">
                            <div class="level" v-for="(level, i) in levels.slice(progression.length + 1, levels.length - currentPercentage + progression.length)">
                                ...
                                <div class="meta">
                                    <p>#{{ level.rank }}</p>
                                    <h2>{{ level.name }}</h2>
                                    <p style="color: var(--color-error); font-weight: 700">{{ currentPercentage + 2 + i }}%</p>
                                </div>
                            </div>
                        </template>
                    </template>
